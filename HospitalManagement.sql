...
------Triggers-----
--To calculate the total bill ,Adding the test charge from test table and other parameters too from the bill table
__________________________________________________________________________________
...
__________________________________________________________________________________
------Function----
--Computed Age column for Patient Table
...
--If bed is available then only it can be assigned.
...
--Trigger 
--For updating the bed availability when patient is discharged or admitted
__________________________________________________________________________________
...
-- Inserting values into the Room_Details table:
...
INSERT INTO Room_Details VALUES (150, 'B', 'No', 8);
 ...
 Update Room_Details  Set Availability = 'Yes ';

-- Inserting values into the Bed_Details Table:
...
INSERT INTO Bed_Details VALUES (400, 'No', 63);
 ...
 Update Bed_Details  Set Availability = 'Yes ';
-- Inserting values in the bill table:


-- Inserting Values into Type Of Cases table:
...
insert into Types_of_Cases 
(Case_id,Type, Description, [Admit Date],[Discharge Date], [idPatient],[idWard],[idBed_Details])
...
Select * from Types_of_Cases toc 
...
____________________________________________________________________________________________
--Views
--To check the current status of number of rooms and beds available in the hospital .
____________________________________________________________________________________________
...
____________________________________________________________________________________________
--Views
--To check the  Daily increase/decrease in number of cases and type of cases
____________________________________________________________________________________________
...
( select CAST([Admit Date] as DATE) as Date,			
 ...
 from temp2 t2 
	...
	____________________________________________________________________________________________
--Views
--To check in which hospital patients are admitted and which ward,room and bed they are allocated TO 
	--this in turn would help the reciptionist too as it would be informative for the visitors
____________________________________________________________________________________________
